 ...
 * Source: https://raw.githubusercontent.com/devcontainers/spec/main/schemas/devContainer.base.schema.json
 * Generated: 2025-12-28T06:26:40.029Z
 *
 ...
 * Docker build-related options.
 */
export interface BuildOptions1 {
  /**
   * Target stage in a multi-stage build.
   */
  target?: string;
...
export interface NonComposeBase {
  /**
...
export interface DevContainerCommon1 {
  /**
   * The JSON schema of the `devcontainer.json` file.
   */
  $schema?: string;
